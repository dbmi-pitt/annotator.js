...
(function() {
  ...
  Range.NormalizedRange = (function() {
    ...
    NormalizedRange.prototype.textNodes = function() {
      ...
      console.log("range.js - textNodes:");
      console.log(textNodes);  

      _ref = [textNodes.index(this.start), textNodes.index(this.end)], start = _ref[0], end = _ref[1];

      var preTextNodeL = $.makeArray(textNodes.slice(start, +end + 1 || 9e9));
      var postTextNodeL = [];
      for (var i=0; i < preTextNodeL.length; i++) {
          if (preTextNodeL[i].data != "" && preTextNodeL[i].data != null)
              postTextNodeL.push(preTextNodeL[i]);
      }

      console.log(postTextNodeL);
      return postTextNodeL;
